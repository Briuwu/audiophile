...
import { handleOrders } from "@/app/actions";
...
export default function CheckoutForm({
  ...
  const [orderedItems, setOrderedItems] = useState<ProductsInCart[]>([]);
  ...
  function onSubmit(data: z.infer<typeof checkoutSchema>) {
    ...
    startTransition(async () => {
      const res = await handleOrders(productIds, data);
  ...
  const GRAND_TOTAL = totalProductPrice + SHIPPING_FEE;
  ...
  return (
    <>
      ...
      {showReceipt && (
        <CheckoutReceipt totalPrice={GRAND_TOTAL} products={orderedItems} />
      )}
    </>
  );
}
